...
def login():
    ...
    if request.method == 'POST':
        ...
        if account:
            ...
            msg = 'Incorrect username / password ! Please enter the valid details.'
    ...
    if request.method == "POST":
        try:
            ...
            if field == 'Price_per_quantity' or field == 'Quantity':
                ...
                insert_sql = 'UPDATE stock_details SET Total_details=? WHERE Name?'
                pstmt = ibm_db.prepare(conn, insert_sql)
    ...
    if request.method == "POST":
        try:
            ...
            if dictionary:
                ...
                query = 'INSERT INTO order_details (Stock_id,Quantity,Date,Delivery_date,Price) VALUES (?,?,?,?,?)'
